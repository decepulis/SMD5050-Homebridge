...
#define OTA_PASSWORD "rgblight" //set you OTA password

#define RED_PIN D8    //set the r,g,b, pin for your esp8266
#define GREEN_PIN D7
#define BLUE_PIN D6
#define BLINK_PIN D4
...
netInfo homeNet = {.name = "hap-nodejs:accessories:RGBLight", .mqtt = "192.168.1.100", .ssid = "***", .pass = "***"};
